...
console.log('Hi');
var left = document.getElementById("value");
var used = document.getElementById("used");
var slider = document.getElementById("slider");
var fill = document.querySelector('.bar .fill');
slider.addEventListener('input', function () {
  fill.style.width = "".concat(slider.value / 10, "%");
  used.innerHTML = "".concat(slider.value, "GB ");
  left.innerHTML = "".concat(1000 - slider.value, "<span class=\"small\">GB Left</span> ");
